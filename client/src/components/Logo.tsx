...
export function Logo({ className = '' }: { className?: string }) {
  return (
    <Link to="/" className={`group inline-flex items-center gap-2 ${className}`}>
      <span className="relative grid h-9 w-9 place-items-center rounded-xl bg-graphite-900 ring-1 ring-graphite-700">
      ...
      <span className="font-display text-lg font-bold tracking-tight text-graphite-100">
